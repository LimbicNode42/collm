...
exports.prismaCore = globalForPrisma.prismaCore ||
    new core_client_1.PrismaClient({
        log: ['query'],
    });
if (process.env.NODE_ENV !== 'production') {
    globalForPrisma.prismaUser = exports.prismaUser;
    globalForPrisma.prismaCore = exports.prismaCore;
}
exports.UserTypes = __importStar(require("../generated/user-client"));
exports.CoreTypes = __importStar(require("../generated/core-client"));
