...
const config = {
  ...
  "inlineSchemaHash": "10ce844faf9d82ac319b3b70360c7cac4ce5d2123bd1ca46d785c7d84196c792",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "packages/database/generated/core-client",
    "database/generated/core-client",
  ]
...
path.join(process.cwd(), "packages/database/generated/core-client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "packages/database/generated/core-client/schema.prisma")
